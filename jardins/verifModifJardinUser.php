...
if ($jardin_photo) {
    ...
    if (move_uploaded_file($_FILES['jardin_photo']['tmp_name'], $dossier . $jardin_photo)) {
        $requete = $bd->prepare('UPDATE jardins SET jardin_nom = ?, jardin_adr = ?, jardin_coordLat = ?, jardin_coordLong = ?, jardin_surface = ?, jardin_infoTerre = ?, jardin_photo = ? WHERE jardin_id = ?');
        $requete->bindParam(1, $jardin_nom);
        $requete->bindParam(2, $jardin_adr);
        $requete->bindParam(3, $jardin_coordLat);
        $requete->bindParam(4, $jardin_coordLong);
        $requete->bindParam(5, $jardin_surface);
        $requete->bindParam(6, $jardin_infoTerre);
    ...
    $requete = $bd->prepare('UPDATE jardins SET jardin_nom = ?, jardin_adr = ?, jardin_coordLat = ?, jardin_coordLong = ?, jardin_surface = ?, jardin_infoTerre = ? WHERE jardin_id = ?');
    $requete->bindParam(1, $jardin_nom);
    $requete->bindParam(2, $jardin_adr);
    $requete->bindParam(3, $jardin_coordLat);
    $requete->bindParam(4, $jardin_coordLong);
